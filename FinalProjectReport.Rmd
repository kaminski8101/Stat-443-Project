...
The exploratory analysis shows possible linear relationships between the
...
calculate the RMSE to measure how spread out these variables are. The
...
3.  Client should make sure all data is entered correctly and note any
    events which require the turbines to shut down.
...
this explanation. 16 observations were removed.
...
- Built/trained initial linear models.  
- Contributed to writing several different sections.  
- Created some of the figures used in the report.  
...
=======
- Created some of the figures used in the report.  
>>>>>>> 2b6bfff4703a5116608b359c5e6eb055a263abc7
